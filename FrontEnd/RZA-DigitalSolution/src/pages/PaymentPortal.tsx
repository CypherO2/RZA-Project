...
/* The `export default function Checkout() {` statement is defining a functional component named `Basket`
...
document title to "Riget Zoo | Payment Portal" using the `useEffect` hook. */
export default function Checkout() {
  useEffect(() => {
    document.title = "Riget Zoo | Payment Portal";
  });
  return (
    <>
